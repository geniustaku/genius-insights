...
export const metadata: Metadata = {
  ...
  keywords: [
    'singapore investment calculator', 'singapore retirement calculator', 'investment calculator Singapore', 'singapore pension calculator'
  ],
  alternates: {
    canonical: '/singapore-investment-calculator',
  },
  openGraph: {
    title: 'Singapore Investment Calculator 2025 | SGX Investment Calculator',
    description: 'Free Singapore investment calculator for 2025. Calculate returns on SGX investments, REITs, stocks.',
    url: 'https://genius-insights.co.za/singapore-investment-calculator',
    type: 'website',
  },
};

export default function SingaporeInvestmentCalculatorPage() {
  return (
    <>
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate investment returns and retirement savings in Singapore.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Singapore Investment Calculator</h2>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Initial Investment (S$)</label>
                  <input
                    type="number"

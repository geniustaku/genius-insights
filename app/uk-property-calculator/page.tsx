...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/uk-property-calculator',
  },
  openGraph: {
    title: 'UK Property Calculator 2025 | Stamp Duty Calculator',
    description: 'Free UK property calculator for 2025. Calculate stamp duty, property investment returns, rental yield.',
    url: 'https://genius-insights.co.za/uk-property-calculator',
    type: 'website',
  },
};
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">United Kingdom Investment Calculator</h2>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid gap-6">
                ...
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300">

...
export const metadata: Metadata = {
  ...
  keywords: [
    'united states loan calculator', 'united states mortgage calculator', 'loan calculator United States', 'united states EMI calculator'
  ],
  alternates: {
    canonical: '/us-student-loan-calculator',
  },
  openGraph: {
    title: 'US Student Loan Calculator 2025 | Education Loan Calculator',
    description: 'Free US student loan calculator for 2025. Calculate student loan payments, interest, repayment plans.',
    url: 'https://genius-insights.co.za/us-student-loan-calculator',
    type: 'website',
  },
};
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate loan payments and interest for mortgages, personal loans, and car loans in United States.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">United States Loan Calculator</h2>

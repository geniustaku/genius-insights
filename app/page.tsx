...
export default async function Home() {
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="px-6 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl">
            ...
            <h3 className="text-lg font-semibold mb-2">Salary Calculator</h3>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl">
            ...
            <Link 
              href="/career-assessment" 
              className="text-emerald-600 text-sm font-medium flex items-center hover:text-emerald-800"
            >
              Find Your Path
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-xl">
            ...
            <h3 className="text-lg font-semibold mb-2">Skills Analyzer</h3>
            <p className="text-gray-600 text-sm mb-4">
              Identify skill gaps and get personalized recommendations to boost your employability.
            </p>
            <Link 
              href="/skills-analyzer" 
              className="text-orange-600 text-sm font-medium flex items-center hover:text-orange-800"
            >
              Analyze Your Skills
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
      ...
      <section className="px-6 py-16 bg-indigo-50 rounded-xl">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">African Job Market Insights</h2>
            <p className="text-gray-600">Explore current trends, in-demand skills, and salary data across Africa</p>
          </div>
      ...
      {/* Stats Section - Minimalist design with updated data */}
      <section className="px-6 max-w-6xl mx-auto">

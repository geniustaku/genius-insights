...
export const metadata: Metadata = {
  ...
  keywords: [
    'germany investment calculator', 'germany retirement calculator', 'investment calculator Germany', 'germany pension calculator'
  ],
  alternates: {
    canonical: '/germany-investment-calculator',
  },
  openGraph: {
    title: 'Germany Investment Calculator 2025 | DAX Investment Calculator',
    description: 'Free Germany investment calculator for 2025. Calculate returns on DAX investments, ETFs, stocks.',
    url: 'https://genius-insights.co.za/germany-investment-calculator',
    type: 'website',
  },
};
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate investment returns and retirement savings in Germany.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Germany Investment Calculator</h2>

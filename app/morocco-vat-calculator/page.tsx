...
export const metadata: Metadata = {
  ...
  keywords: [
    'morocco VAT calculator', '20% VAT calculator', 'morocco VAT rates', 'VAT calculator Morocco'
  ],
  alternates: {
    canonical: '/morocco-vat-calculator',
  },
  openGraph: {
    title: 'Morocco VAT Calculator 2025 | 20% VAT Calculator',
    description: 'Free Morocco VAT calculator for 2025. Calculate 20% VAT on goods and services. Moroccan VAT calculations.',
    url: 'https://genius-insights.co.za/morocco-vat-calculator',
    type: 'website',
  },
};

export default function MoroccoVATCalculatorPage() {
  return (
    <>
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                Morocco VAT Calculator <br/>
                <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">2025</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate 20% VAT on goods and services in Morocco.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Morocco VAT Calculator</h2>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Amount (DH)</label>
                  <input
                    type="number"

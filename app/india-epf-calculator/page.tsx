...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/india-epf-calculator',
  },
  openGraph: {
    title: 'India EPF Calculator 2025 | Provident Fund Calculator',
    description: 'Free India EPF calculator for 2025. Calculate EPF contributions, employer contributions, retirement corpus.',
    url: 'https://genius-insights.co.za/india-epf-calculator',
    type: 'website',
  },
};
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">India Investment Calculator</h2>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid gap-6">
                ...
                <button className="w-full bg-gradient-to-r from-orange-600 to-green-600 text-white py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300">

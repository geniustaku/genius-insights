...
export const metadata: Metadata = {
  ...
  keywords: [
    'germany loan calculator', 'germany mortgage calculator', 'loan calculator Germany', 'germany EMI calculator'
  ],
  alternates: {
    canonical: '/germany-loan-calculator',
  },
  openGraph: {
    title: 'Germany Loan Calculator 2025 | Mortgage & Personal Loan Calculator',
    description: 'Free Germany loan calculator for 2025. Calculate mortgage payments, personal loans with German bank rates.',
    url: 'https://genius-insights.co.za/germany-loan-calculator',
    type: 'website',
  },
};
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate loan payments and interest for mortgages, personal loans, and car loans in Germany.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Germany Loan Calculator</h2>

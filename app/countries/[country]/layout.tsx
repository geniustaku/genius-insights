...
const countryConfigs = {
  'south-africa': {
    name: 'South Africa',
    seoTitle: 'South Africa Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'nigeria': {
    name: 'Nigeria',
    seoTitle: 'Nigeria Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'kenya': {
    name: 'Kenya',
    seoTitle: 'Kenya Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'ghana': {
    name: 'Ghana',
    seoTitle: 'Ghana Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'united-kingdom': {
    name: 'United Kingdom',
    seoTitle: 'UK Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'canada': {
    name: 'Canada',
    seoTitle: 'Canada Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'united-states': {
    name: 'United States',
    seoTitle: 'US Professional Tools | Tax Calculator, Resume Builder & Financial Planning 2026',
  ...
  'india': {
    name: 'India',
    seoTitle: 'India Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'egypt': {
    name: 'Egypt',
    seoTitle: 'Egypt Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'morocco': {
    name: 'Morocco',
    seoTitle: 'Morocco Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'australia': {
    name: 'Australia',
    seoTitle: 'Australia Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'germany': {
    name: 'Germany',
    seoTitle: 'Germany Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'france': {
    name: 'France',
    seoTitle: 'France Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'singapore': {
    name: 'Singapore',
    seoTitle: 'Singapore Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
  ...
  'uae': {
    ...
    seoTitle: 'UAE Professional Tools | VAT Calculator, CV Builder & Financial Planning 2026',
  ...
  'brazil': {
    name: 'Brazil',
    seoTitle: 'Brazil Professional Tools | Tax Calculator, CV Builder & Financial Planning 2026',
...
export function generateStaticParams() {
  return Object.keys(countryConfigs).map((country) => ({ country }));
}
...
export async function generateMetadata({ params }: { params: Promise<{ country: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://www.genius-insights.co.za/api/og?title=${encodeURIComponent(country.name + ' Financial Tools')}&subtitle=${encodeURIComponent('Tax Calculator • CV Builder • Loans')}`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: country.seoTitle,
      description: country.seoDescription,
      images: [`https://www.genius-insights.co.za/api/og?title=${encodeURIComponent(country.name + ' Financial Tools')}&subtitle=${encodeURIComponent('Tax Calculator • CV Builder • Loans')}`],

...
export const metadata: Metadata = {
  ...
  keywords: [
    'france investment calculator', 'france retirement calculator', 'investment calculator France', 'france pension calculator'
  ],
  alternates: {
    canonical: '/france-investment-calculator',
  },
  openGraph: {
    title: 'France Investment Calculator 2025 | CAC 40 Investment Calculator',
    description: 'Free France investment calculator for 2025. Calculate returns on CAC 40 investments, ETFs, stocks.',
    url: 'https://genius-insights.co.za/france-investment-calculator',
    type: 'website',
  },
};

export default function FranceInvestmentCalculatorPage() {
  return (
    <>
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                France Investment Calculator <br/>
                <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">2025</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate investment returns and retirement savings in France.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">France Investment Calculator</h2>

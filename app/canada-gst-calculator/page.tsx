...
export const metadata: Metadata = {
  ...
  keywords: [
    'canada VAT calculator', '13% VAT calculator', 'canada VAT rates', 'VAT calculator Canada', 'canada sales tax'
  ],
  alternates: {
    canonical: '/canada-vat-calculator',
  },
  openGraph: {
    title: 'Canada GST/HST Calculator 2025 | GST HST Calculator',
    description: 'Free Canada GST/HST calculator for 2025. Calculate GST, HST, PST for all provinces. CRA compliant tax calculations for Canadian businesses.',
    url: 'https://genius-insights.co.za/canada-vat-calculator',
    type: 'website',
  },
};

export default function CanadaVATCalculatorPage() {
  return (
    <>
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              <div className="inline-block bg-white/20 rounded-2xl px-6 py-3 mb-6">
                <span className="text-white/90 font-medium text-sm tracking-wide">🇨🇦 13% VAT Rate</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                Canada VAT Calculator <br/>
                <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">2025</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate 13% VAT on goods and services in Canada. Free VAT calculator for Canada businesses and consumers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Canada VAT Calculator</h2>
              <p className="text-gray-600">Calculate 13% VAT inclusive and exclusive amounts</p>
            </div>
            
            <div className="max-w-2xl mx-auto">
              <div className="grid gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Amount (C$)</label>
                  <input
                    type="number"

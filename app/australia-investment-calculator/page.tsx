...
export const metadata: Metadata = {
  ...
  keywords: [
    'australia investment calculator', 'australia retirement calculator', 'investment calculator Australia', 'australia pension calculator'
  ],
  alternates: {
    canonical: '/australia-investment-calculator',
  },
  openGraph: {
    title: 'Australia Investment Calculator 2025 | ASX Investment Calculator',
    description: 'Free Australia investment calculator for 2025. Calculate returns on ASX investments, shares, managed funds.',
    url: 'https://genius-insights.co.za/australia-investment-calculator',
    type: 'website',
  },
};

export default function AustraliaInvestmentCalculatorPage() {
  return (
    <>
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                Australia Investment Calculator <br/>
                <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">2025</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate investment returns and retirement savings in Australia.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Australia Investment Calculator</h2>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Initial Investment (A$)</label>
                  <input
                    type="number"

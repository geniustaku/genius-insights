...
export const metadata: Metadata = {
  ...
  keywords: [
    'nigeria business calculator', 'nigeria business registration', 'business calculator Nigeria', 'nigeria startup costs'
  ],
  alternates: {
    canonical: '/nigeria-business-calculator',
  },
  openGraph: {
    title: 'Nigeria Business Calculator 2025 | CAC Registration Cost Calculator',
    description: 'Free Nigeria business calculator for 2025. Calculate CAC registration costs, business setup fees.',
    url: 'https://genius-insights.co.za/nigeria-business-calculator',
    type: 'website',
  },
};

export default function NigeriaBusinessCalculatorPage() {
  return (
    <>
          ...
          <div className="relative max-w-7xl mx-auto px-8 py-20">
            <div className="text-center">
              <div className="inline-block bg-white/20 rounded-2xl px-6 py-3 mb-6">
                <span className="text-white/90 font-medium text-sm tracking-wide">🇳🇬 Business Calculator</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                Nigeria Business Calculator <br/>
                <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">2025</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light mb-8">
                Calculate business registration costs and startup expenses in Nigeria.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-8 py-16">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Nigeria Business Calculator</h2>
